...
| ---- | ------ | -------- | ---------------- | -------- | ------------ | ---------------- | -------- | -------- |
| 区域 | D_TEST | 1        | DISTRICT_CAMPUS  | 1        | 1            | DISTRICT_CAMPUS  | 区域名字 | 区域描述 |
| 建筑 | B_TEST | 1        | BUILDING_LIBRARY | 1        | 1            | BUILDING_LIBRARY | 建筑名字 | 建筑描述 |
| 单位 | U_TEST | 1        | 0                | 0        | 0            | UNIT_WARRIOR     | 单位名字 | 单位描述 |
...
| 列名           | 文明/领袖          | 简称（向右延伸）                | ...    | ...    | ... |
| -------------- | ------------------ | ------------------------------- | ------ | ------ | --- |
| 文明绑定       | TEST               | D_TEST                          | B_TEST | U_TEST | ... |
| 领袖绑定       | TEST               | IMP_TEST                        |        |        | ... |
| **列名** | **总督简称** | **文明/领袖（向右延伸）** |        |        | ... |
